...
int main(int argc, char **argv)
{
    ...
    while(ros::ok() && !current_state.armed){
      ...
      ROS_INFO("TRYING FOR MARK I");
       for(int i = 45; ros::ok() && i > 0; --i){
          pubpoints(-1, -1, 3, 0);
          ros::spinOnce();
          rate.sleep();
      ...
      ROS_INFO("reached markI");
      
      ROS_INFO("TRYING FOR MARK II");  
       for(int i = 45; ros::ok() && i > 0; --i){
          pubpoints(1, 1, 1, 0);
          ros::spinOnce();
          rate.sleep();

          pubpoints(0, 1.1, 2.5, 1);
          ros::spinOnce();
          rate.sleep();
      ...
      ROS_INFO("successfully reached mark II");
